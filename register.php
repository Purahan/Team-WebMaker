            ...
            <div class="container bg-light my-5 py-4 px-5">
                ...
                <div class="row pb-3">
                    ...
                    <div class="col">
                        ...
                        <input type="tel" class="form-control" placeholder="Mobile Number" name="Mobile" id="Mobile" required />
                    </div>
                </div>
                <hr>
                <p>By creating an account you agree to our <a href="#">Terms & Privacy</a>.</p>

                <input type="submit" class="btn btn-success w-100 px-2 py-2 fs-5"    <a href="thank.html"</a>
